...
2.  Then you specify a range of plausible alternative models, which include additional candidate variables, usually based upon a theoretical or scientific framework.[Usually you choose candidate variables from what is already **known** in the literature.]{.aside}
...
You can find most of this information in the final estimation @tbl-catable as presented in @stock2003introduction. Here, we make use of the `summary_col` function from `statsmodels`. Although, not as smooth as likewise packages in other languages, this does the trick and finally we got rid of that ugly regression output that `Python` produces. 
...
#| label: fig-rplot1
#| fig-align: 'center'
#| fig-cap: "Negative relation between thrustworthiness and newsworthiness" 
#| echo: False
knitr::include_graphics("./figures/Rplot01.png", dpi = 90)
```
