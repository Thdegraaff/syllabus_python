...
Indeed, there might be evidence that the relation depicted in @fig-cloud2---if anything---is linear. But, clearly that is not the case for the relation between test scores and average district income. Namely, the syntax below:
...
```{python}
#| fig.cap: "A non-linear relation with the log of average district income"
